...
try:
    import global_utils
    from PlainNet import super_blocks, SuperVoVKXLX
except ImportError:
...
seach_space_block_type_list_list = [
    [SuperVoVKXLX.SuperVoVK3L1, 
     ...
     SuperVoVKXLX.SuperVoVK5L1, 
     SuperVoVKXLX.SuperVoVK5L2, 
     SuperVoVKXLX.SuperVoVK5L3,
     SuperVoVKXLX.SuperVoVK5L4,
     SuperVoVKXLX.SuperVoVK5L5,
     SuperVoVKXLX.SuperVoVK7L1, 
     SuperVoVKXLX.SuperVoVK7L2, 
     SuperVoVKXLX.SuperVoVK7L3,
     SuperVoVKXLX.SuperVoVK7L4,
     SuperVoVKXLX.SuperVoVK7L5],
]
...
__block_type_round_channels_base_dict__ = {
    ...
    SuperVoVKXLX.SuperVoVK5L1: 8,
    SuperVoVKXLX.SuperVoVK5L2: 8,
    SuperVoVKXLX.SuperVoVK5L3: 8,
    SuperVoVKXLX.SuperVoVK5L4: 8,
    SuperVoVKXLX.SuperVoVK5L5: 8,
    SuperVoVKXLX.SuperVoVK7L1: 8,
    SuperVoVKXLX.SuperVoVK7L2: 8,
    SuperVoVKXLX.SuperVoVK7L3: 8,
    SuperVoVKXLX.SuperVoVK7L4: 8,
